			...
			if code in ca[1]:
				...
				if len(ca) > 2 and ca[2] != '~':
					...
					for li in ca[2]:
						if isinstance(
								li,
								list) or isinstance(li,
													tuple):  # 16.04.28 pas I am not happy with this contigency: things should be stored in just one format, but don't have time to resolve this at the moment
							haha = []
							for l in li:
